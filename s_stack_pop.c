...
/*   Updated: 2024/10/26 02:28:43 by iboukhss         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	stack_a_pop_back(int *out_val, t_stack *stack)
{
	...
	move_size = (stack->end_b - stack->end_a) * sizeof(int);
...
int	stack_a_pop_front(int *out_val, t_stack *stack)
{
	...
	if (out_val != NULL)
		*out_val = *(stack->beg_a);
	move_size = (stack->end_b - stack->beg_a - 1) * sizeof(int);
...
int	stack_b_pop_front(int *out_val, t_stack *stack)
{
	...
	if (out_val != NULL)
		*out_val = *(stack->beg_b);
	move_size = (stack->end_b - stack->beg_b - 1) * sizeof(int);
